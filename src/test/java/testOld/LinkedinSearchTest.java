...
import pageOld.LinkedinSearchPage;
...
public class LinkedinSearchTest extends LinkedinBaseTest {
    ...
    public void basicSearchTest(String userEmail, String userPassword){
        ...
        Assert.assertTrue(linkedinSearchPage.isPageLoaded(), "Search pageOld is not loaded.");

        Assert.assertEquals(linkedinSearchPage.getSearchResultsNumber(), 10,
                "Wrong number of searchResults on Search pageOld.");
