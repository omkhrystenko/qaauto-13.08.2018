...
public class LinkedinSearchTest extends LinkedinBaseTest {
    ...
    public Object[][] search_HomePage() {
        return new Object[][]{
                {"autotestqa2018@gmail.com", "trust2018", "hr"}
        };
    }
    ...
    public void searchTestHomePage(String userEmail, String userPassword, String requestData){
        ...
        Assert.assertEquals(linkedinHomePage.quantityOfSearchFormAnswers(), 10, "Quantity of answers on search form is wrong");
        Assert.assertEquals(linkedinHomePage.quantityOfMatchResults(requestData), 10, "Not all the results coincided");
